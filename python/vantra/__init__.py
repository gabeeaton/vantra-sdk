...
# Spans collected within a trace, flushed together after trace is posted
...
# Queue for spans outside of a trace context
_queue: deque = deque()
...
def _queue_span(span_data: dict):
    """Route span to pending list (inside a trace) or background queue (outside)."""
